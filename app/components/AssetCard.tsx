...
<div
	...
	aria-label={`s\uv2actionMetadata. name (${asset.code})`}
	onClick={handleClick}
...
{selected && (
<span
	className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[var(--color-theme-primary)] text-white"
	aria-label="Selected"
>
⌓
</span>
